...
// context1.filter = `hue-rotate(${ 360/1 }deg)`;
// context2.filter = `hue-rotate(${ 360/2 }deg)`;
// context3.filter = `hue-rotate(${ 360/3 }deg)`;
// context4.filter = `hue-rotate(${ 360/4 }deg)`;
// context5.filter = `hue-rotate(${ 360/5 }deg)`;
...
// debugger
// var angryAlien = new Image();
// angryAlien.src = "../assets/images/aliens/";
// var ninjaAlien = new Image();
// angryAlien.src = "../assets/images/aliens/";
// var geekAlien = new Image();
var coolAlien = new Image();
coolAlien.src = "../assets/images/aliens/green/Smiley_green_alien_big_eyes.svg";
// angryAlien.src = "../assets/images/aliens/";
// coolAlien.style.filter = "hue-rotate(90deg)";
// coolAlien.style.cssText = "-webkit-filter: hue-rotate(90deg)";
// ctx.drawImage(coolAlien,0,0);
...
Alien.prototype.draw = function() {
  ...
  ctx.filter = `hue-rotate(${ this.type }deg)`;
  ctx.drawImage(coolAlien, this.pos[0], this.pos[1], 2 * this.radius, 2 * this.radius);
  ctx.filter = "none";
  ctx.translate(this.radius, this.radius);
  // debugger
  // this.type.translate(-this.radius, -this.radius);
  // this.type.drawImage(coolAlien, this.pos[0], this.pos[1], 2 * this.radius, 2 * this.radius);
  // this.type.translate(this.radius, this.radius);
};
