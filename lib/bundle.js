...
/***/ function(module, exports, __webpack_require__) {
	...
	const initFirebase = __webpack_require__(8);
...
/***/ function(module, exports, __webpack_require__) {
	...
	Game.prototype.end = function(text) {
	  ...
	  if (!user) {
	    document.getElementById('main-auth-button').disabled = true;
	  } else if(this.brood.win){
	    // debugger
	    let gameData = user.providerData.map(function (profile) {
	  ...
	  // $replayMessage.append('<br><i class="fa fa-refresh" aria-hidden="true"></i><br>');
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function() {
	  ...
	  var config = {
	    apiKey: "AIzaSyDXuqRORiH9i9kgtNo8dJfLvMihWjkZ3I4",
	    authDomain: "brood-6634d.firebaseapp.com",
	    databaseURL: "https://brood-6634d.firebaseio.com",
	    storageBucket: "",
	  };
	  ...
	  function initApp() {
	    ...
	    firebase.auth().onAuthStateChanged(function(user) {
	      if (user) {
	        ...
	        document.getElementById('main-auth-button').textContent = 'Sign out';
	        $('#quickstart-sign-in').css("display",'none');
	        ...
	        // [START_EXCLUDE]
	        // debugger
	        document.getElementById('main-auth-button').textContent = 'Sign in with Google';
	        // [END_EXCLUDE]
	      }
	      // [START_EXCLUDE]
	    ...
	    document.getElementById('main-auth-button').addEventListener('click', toggleSignIn, false);
	  }
