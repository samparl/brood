// (function() {
  ...
  Modal.prototype.close = function() {
    ...
    this.modal.className = this.modal.className.replace(" scotch-anchored", "");

    // Listen for CSS transitioned event and remove nodes from the DOM
    this.modal.addEventListener(this.transitionEnd, function(e) {
      _.overlay.className = _.overlay.className.replace(" scotch-open", "");
      _.modal.removeEventListener(e.type, arguments.callee);
